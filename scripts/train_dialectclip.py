...
from dialect_clip import DialectCLIP, DialectCLIPForConditionalGeneration
from dialect_clip import DialectCLIPConfig, DialectCLIPTrainerConfig
from dialect_clip import DialectCLIPTrainer
...
def main():
    ...
    dialectclip_trainer = DialectCLIPTrainer(config=train_config)
